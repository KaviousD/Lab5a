...
function sumAndMultiply(a, b, c) {
    ...
    let str1A = a + " and " + b + " and " + c + " sums to " + sum2 + ".";
    let str2B = "The product of " + a + " and " + b + " and " + c + " is " + product2 + ".";
    let arr3 = [];
    arr3[0] = sum2;
    arr3[1] = product2;
    arr3[2] = str1A;
...
function multiplyArray(multArr) {
    let product5 = multiply(multArr[0], multArr[1])[0];
    let product6 = multiply(product5, multArr[2])[0];
    let str5 =
        “The numbers ” + multArr + ” have a product of ” + product6 + “.”;
    let arr5b = [];
    arr5b[0] = product6;
    arr5b[1] = str5;
    return arr5b;
